...
namespace Proyecto_Visualizador3D
{
    public partial class FrmSphere : Form
    {
        ...
        public FrmSphere()
        {
            ...
            figure = new Sphere3D(100, 20, 20);
            renderer = new FigureRenderer();
            picCanvas.BackColor = Color.FromArgb(30, 30, 30);
            esféaToolStripMenuItem.ForeColor = Color.FromArgb(30, 30, 30);
            keyTimer = new Timer();
        ...
        private void FrmSphere_KeyDown(object sender, KeyEventArgs e)
        {
            keysPressed.Add(e.KeyCode);
        }

        private void FrmSphere_KeyUp(object sender, KeyEventArgs e)
        {
